...
INSERT INTO "new_Adress" ("appartament", "entrants", "home", "id", "postDepartament", "street", "userId") SELECT "appartament", "entrants", "home", "id", "postDepartament", "street", "userId" FROM "Adress";
DROP TABLE "Adress";
