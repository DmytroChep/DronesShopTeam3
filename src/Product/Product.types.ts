...
export type ProductWithTagsAndOrders = Prisma.ProductGetPayload<{
	include: {
		category: true;
		_count: {
...
export interface ControllerContract {
	getAllProducts: (
		req: Request<object, Product[] | string, object>,
		res: Response<Product[] | string>,
	) => Promise<void>;
	getProductById: (
		req: Request<{ id: number }, Product | string | null, object>,
		res: Response<Product | string | null>,
	) => Promise<void>;
	addProductToJson: (
		req: Request<object, Product | string, Product>,
		res: Response<Product | string>,
	) => Promise<void>;
	updateDataProduct: (
		req: Request<{ id: number }, UpdateProduct | string, UpdateProduct>,
		res: Response<UpdateProduct | string>,
	) => Promise<void>;
	deleteProduct: (
		req: Request<{ id: number }, Product | string, Product>,
		res: Response<Product | string>,
	) => Promise<void>;
