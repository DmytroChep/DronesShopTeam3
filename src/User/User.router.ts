...
userRouter.get("/user/getUser/:id", authMiddleware, UserController.getUserWithRelations)
...
userRouter.delete("/user/order/:id", authMiddleware, UserController.cancelOrder)
