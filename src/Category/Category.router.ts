...
categoryRouter.post("/category", authMiddleware, CategoryController.addCategoryToJson)
categoryRouter.patch("/category/:id", authMiddleware, CategoryController.updateDataCategory)
